  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: BlocProvider<SignupBloc>(
          create: (context) => SignupBloc(AuthInfrastractureProvider.provideAuthRepository()),
                ...
                child: SizedBox(
                  ...
                  child: ListView(
                    children: [
                      ...
                      _padding(),
                      DatePickerButton(controller: _datePickerController, child: Text("Date of Birth")),
                      _padding(),
                      TextFormField(
...
class CustomDropDownWidget extends StatefulWidget {
  ...
  @override
  State<CustomDropDownWidget> createState() => _CustomDropDownWidgetState(controller);
}
